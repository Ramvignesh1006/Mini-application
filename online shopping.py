dress=[{"id":1001,"Name":"T-Shirt","Available":10,"Price":250,"Original_Price":200},
       {"id":1002,"Name":"Pants","Available":12,"Price":500,"Original_Price":450},
       {"id":1003,"Name":"Shirt","Available":100,"Price":750,"Original_Price":700},
       {"id":1004,"Name":"Shorts","Available":20,"Price":350,"Original_Price":300},
       {"id":1005,"Name":"Shoes","Available":15,"Price":400,"Original_Price":300}]
dress1=dress
temp=[]
order=""
...
def userDisplayMenu():
                ...
                for d in dress:
                    ...
                    print(d['id'],d['Name'],d['Available'],d['Price'])
def user_id():
    userDisplayMenu()
    p_id=int(input("\nEnter the id : "))
def placeOrder():
...
def cancelOrder():
    ...
    if len(temp)==d:
        ...
        print("Your order is removed from the placed order")
